...
class IndexController extends Controller
{
    public function index(){
        ...
        return view('frontEnd.index',compact('products','userid'));
    }
    ...
    public function predict(Request $request){
        ...
        $result=shell_exec("C:/users/shrav/Anaconda3/scripts/activate base && python C:/xampp/htdocs/fms/public/temp.py $temp $hum $ph $rain 2>&1");
        return $result;
    }
}
